...
class VideoStreamHandler(socketserver.StreamRequestHandler):
    ...
    nn = NeuralNetwork()
    nn.load_model("saved_model/model_test.xml")
    print("check_model")
    obj_detection = ObjectDetection()
    print("check_obj_detection")
    rc_car = RCControl("/dev/cu.HC05_SLAVE-DevB") 
    print("check_rc_car")
    # cascade classifiers
        ...
        try:
            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    #print("6")
                    # reshape image
                    #image_array = roi.reshape(192, 320).astype(np.float32)
                    image_array = roi.reshape(192, 320).astype(np.uint8)
                    #print (image_array[100][50:100])
                    #print("7") 
...
if __name__ == '__main__':
    h, p1, p2 = "192.168.43.34", 8010, 8002
